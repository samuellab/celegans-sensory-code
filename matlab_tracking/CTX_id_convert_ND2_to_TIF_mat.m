function CTX_id_convert_ND2_to_TIF_mat(nd2_file, varargin)
...
green_vol = zeros(size_Y,size_X,size_Z,size_T);
red_vol = zeros(size_Y,size_X,size_Z,size_T);
...
save(fullfile(tif_directory,'gcamp_vol_16.mat'),'-v7.3','green_vol')
save(fullfile(tif_directory,'red_vol_16.mat'),'-v7.3','red_vol')
